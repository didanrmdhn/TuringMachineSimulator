...
function step(){
   ...
   //NEG X NEG
    ...
    go(20, 'B','B','B', 25, '0','B','B','L','L','S',1);//
    go(25, '0','B','B', 25, '0','B','B','L','L','S',0);
    go(25, 'C','B','B', 26, 'C','B','B','L','L','S',0);
    ...
    go(8, 'B','B','B', 55881, 'B','B','B','R','R','S',0);
        ...
        go(5520, 'B','B','B', 5525, '0','B','B','L','L','S',1);//
        go(5525, '0','B','B', 5525, '0','B','B','L','L','S',0);
        go(5525, 'C','B','B', 5526, 'C','B','B','L','L','S',0);
        go(5526, '0','B','B', 5526, '0','B','B','L','L','S',0);
        go(5526, 'B','X','B', 55881, 'B','X','B','R','R','S',0);
        go(55881, 'C','B','B',55882, 'B','B','B','R','R','S',0);
        go(55882, '0','B','B',55882, '0','B','B','R','R','S',0);
